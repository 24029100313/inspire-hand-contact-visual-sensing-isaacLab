#!/usr/bin/env python3
"""
Convert Inspire Hand URDF with Middle Force Sensor 2 Pads to USD
Creates a single USD file and corresponding YAML configuration
Total: 792 sensor pads
"""
...
class InspireHandMiddle2USDConverter:
    def __init__(self, source_dir="/home/larry/NVIDIA_DEV/isaac_grasp_ws/cabinet_sensor_project"):
        """Initialize the USD converter for Inspire Hand with Middle2 Pads"""
        ...
        # Use the URDF with middle2 sensor pads
        ...
        print(f"🔧 Inspire Hand USD Converter (with Middle2 Pads) initialized")
    ...
    def create_isaac_lab_config(self):
        """Create Isaac Lab configuration YAML with Middle2 pads"""
        config_content = f'''# Isaac Lab Asset Configuration - Inspire Hand with Middle Force Sensor 2 Pads
# Generated from: {self.processed_urdf.name}
# Creation date: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
# Total contact points: 792 (including 80 middle2 pads)

inspire_hand_with_middle2_pads:
  ...
  total_sensors:
    ...
    index2_pads: 80
    middle1_pads: 80
    middle2_pads: 80  # NEW: Middle force sensor 2
    ring1_pads: 80
    little1_pads: 80
    total_contact_points: 792  # 112+96+8+96+80+80+80+80+80+80
    force_sensors: 10
...
'''
    ...
    def convert(self):
        ...
        print("\n🚀 Starting Inspire Hand URDF to USD conversion (with Middle2 pads)")
        print("=" * 70)
        ...
        try:
            ...
            print("✅ All 792 sensor pads (including middle2) converted")
...
def main():
    ...
    converter = InspireHandMiddle2USDConverter()
