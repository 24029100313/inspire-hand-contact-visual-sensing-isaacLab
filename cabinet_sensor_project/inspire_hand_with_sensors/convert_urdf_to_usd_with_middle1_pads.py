#!/usr/bin/env python3
"""
Convert Inspire Hand URDF with Middle Force Sensor 1 Pads to USD
...
class InspireHandMiddle1USDConverter:
    def __init__(self, source_dir="/home/larry/NVIDIA_DEV/isaac_grasp_ws/cabinet_sensor_project"):
        """Initialize the USD converter for Inspire Hand with Middle1 Pads"""
        ...
        # Use the URDF with middle1 sensor pads
        ...
        print(f"🔧 Inspire Hand USD Converter (with Middle1 Pads) initialized")
    ...
    def create_isaac_lab_config(self):
        """Create Isaac Lab configuration YAML with Middle1 pads"""
        config_content = f'''# Isaac Lab Asset Configuration - Inspire Hand with Middle Force Sensor 1 Pads
# Generated from: {self.processed_urdf.name}
# Creation date: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
# Total contact points: 472 (including 80 new middle1 pads)

inspire_hand_with_middle1_pads:
  ...
  contact_sensors:
    ...
    # Middle1 sensor pads (8x10 = 80 sensors, 1.2x1.2x0.6mm, cyan) - NEW
...
'''
    ...
    def convert(self):
        ...
        print("\n🚀 Starting Inspire Hand URDF to USD conversion (with Middle1 pads)")
        print("=" * 70)
        ...
        try:
            ...
            print("✅ All 472 sensor pads (including 80 new middle1 pads) converted")
...
def main():
    ...
    converter = InspireHandMiddle1USDConverter()
