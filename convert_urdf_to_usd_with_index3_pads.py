...
class InspireHandIndex3USDConverter:
    def __init__(self, source_dir="/home/larry/NVIDIA_DEV/isaac_grasp_ws/cabinet_sensor_project"):
        """Initialize the USD converter for Inspire Hand with Index3 Pads"""
        ...
        # Use the URDF with index3 sensor pads
        ...
        print(f"🔧 Inspire Hand USD Converter (with Index3 Pads) initialized")
    ...
    def create_isaac_lab_config(self):
        """Create Isaac Lab configuration YAML with Index3 pads"""
        config_content = f'''# Isaac Lab Asset Configuration - Inspire Hand with Index Force Sensor 3 Pads
# Generated from: {self.processed_urdf.name}
# Creation date: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
# Total contact points: 961 (including 9 index3 pads)

inspire_hand_with_index3_pads:
  ...
  contact_sensors:
    ...
    # Index3 sensor pads (3x3 = 9 sensors, 1.2x1.2x0.6mm, dark_red)
    index_sensor_3_pads:
  ...
  total_sensors:
    ...
    index1_pads: 80
    index2_pads: 80
    index3_pads: 9  # NEW: Index force sensor 3 (fingertip)
    middle1_pads: 80
    middle2_pads: 80
    ring1_pads: 80
    ring2_pads: 80
    little1_pads: 80
    little2_pads: 80
    total_contact_points: 961  # 112+96+8+96+80+80+9+80+80+80+80+80+80
    force_sensors: 13
...
'''
    ...
    def convert(self):
        ...
        print("\n🚀 Starting Inspire Hand URDF to USD conversion (with Index3 pads)")
        print("=" * 70)
        ...
        try:
            ...
            print("✅ All 961 sensor pads (including index3) converted")
...
def main():
    ...
    converter = InspireHandIndex3USDConverter()
