#!/usr/bin/env python3
"""
Convert Inspire Hand URDF with Index Force Sensor 2 Pads to USD
Creates a single USD file and corresponding YAML configuration
Total: 712 sensor pads
"""
...
class InspireHandIndex2USDConverter:
    def __init__(self, source_dir="/home/larry/NVIDIA_DEV/isaac_grasp_ws/cabinet_sensor_project"):
        """Initialize the USD converter for Inspire Hand with Index2 Pads"""
        ...
        # Use the URDF with index2 sensor pads
        ...
        print(f"🔧 Inspire Hand USD Converter (with Index2 Pads) initialized")
    ...
    def create_isaac_lab_config(self):
        """Create Isaac Lab configuration YAML with Index2 pads"""
        config_content = f'''# Isaac Lab Asset Configuration - Inspire Hand with Index Force Sensor 2 Pads
# Generated from: {self.processed_urdf.name}
# Creation date: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
# Total contact points: 712 (including 80 index2 pads)

inspire_hand_with_index2_pads:
  ...
  total_sensors:
    ...
    thumb3_pads: 96
    index1_pads: 80
    index2_pads: 80  # NEW: Index force sensor 2
    middle1_pads: 80
    ring1_pads: 80
    little1_pads: 80
    total_contact_points: 712  # 112+96+8+96+80+80+80+80+80
    force_sensors: 9
...
'''
    ...
    def convert(self):
        ...
        print("\n🚀 Starting Inspire Hand URDF to USD conversion (with Index2 pads)")
        print("=" * 70)
        ...
        try:
            ...
            print("✅ All 712 sensor pads (including index2) converted")
...
def main():
    ...
    converter = InspireHandIndex2USDConverter()
