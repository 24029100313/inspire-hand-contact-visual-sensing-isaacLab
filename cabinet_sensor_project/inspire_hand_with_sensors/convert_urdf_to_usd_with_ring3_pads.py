#!/usr/bin/env python3
"""
Convert Inspire Hand URDF with ring_force_sensor_3 pads to USD
Total sensor pads: 979 (including 9 new ring_sensor_3 pads)
...
def convert_to_usd():
    ...
    try:
        ...
        if os.path.exists(usd_path):
            ...
            print("\n🎯 Conversion Summary:")
            print("   • Total sensor pads: 979")
            print("   • New ring_sensor_3 pads: 9 (3×3)")
...
def main():
    ...
    print("   Target: inspire_hand_processed_with_pads.urdf (979 sensor pads)")
    print("   Includes: 9 new ring_sensor_3 pads (3×3 layout)")
    print("")
