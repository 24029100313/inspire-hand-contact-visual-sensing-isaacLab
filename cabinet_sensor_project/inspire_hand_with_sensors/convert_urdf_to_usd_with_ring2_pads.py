#!/usr/bin/env python3
"""
Convert Inspire Hand URDF with Ring Force Sensor 2 Pads to USD
Creates a single USD file and corresponding YAML configuration
Total: 872 sensor pads
"""
...
class InspireHandRing2USDConverter:
    def __init__(self, source_dir="/home/larry/NVIDIA_DEV/isaac_grasp_ws/cabinet_sensor_project"):
        """Initialize the USD converter for Inspire Hand with Ring2 Pads"""
        ...
        # Use the URDF with ring2 sensor pads
        ...
        print(f"🔧 Inspire Hand USD Converter (with Ring2 Pads) initialized")
    ...
    def create_isaac_lab_config(self):
        """Create Isaac Lab configuration YAML with Ring2 pads"""
        config_content = f'''# Isaac Lab Asset Configuration - Inspire Hand with Ring Force Sensor 2 Pads
# Generated from: {self.processed_urdf.name}
# Creation date: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
# Total contact points: 872 (including 80 ring2 pads)

inspire_hand_with_ring2_pads:
  ...
  total_sensors:
    ...
    middle2_pads: 80
    ring1_pads: 80
    ring2_pads: 80  # NEW: Ring force sensor 2
    little1_pads: 80
    total_contact_points: 872  # 112+96+8+96+80+80+80+80+80+80+80
    force_sensors: 11
...
'''
    ...
    def convert(self):
        ...
        print("\n🚀 Starting Inspire Hand URDF to USD conversion (with Ring2 pads)")
        print("=" * 70)
        ...
        try:
            ...
            print("✅ All 872 sensor pads (including ring2) converted")
...
def main():
    ...
    converter = InspireHandRing2USDConverter()
