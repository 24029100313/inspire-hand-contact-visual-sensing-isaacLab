...
class InspireHandUSDConverter:
    ...
    def create_isaac_lab_config(self):
        ...
        config_content = f'''# Isaac Lab Asset Configuration
...
inspire_hand_with_sensors:
  ...
  contact_sensors:
    ...
    # Palm sensor pads (72 individual sensors)
    palm_sensor_pads:
...
sensor_specifications:
  palm_sensor_pads:
    ...
    coverage_area: [0.030, 0.010]  # 30x10mm in meters
    layout:
      grid_size: [18, 4]
      spacing: [0.00167, 0.0025]  # 1.67x2.5mm spacing
'''
    ...
    def run_conversion(self):
        ...
        try:
            ...
            print(f"📊 Total sensor pads: 72 (18×4 grid)")
...
def main():
    ...
    print("Converting URDF with 72 sensor pads to USD format")
    print("=" * 60)
